...
from graph import interlacing_edges, pathlen, edges_on_path
from graph import flip_and_negate_path, remove_edge_bidir, add_edge_bidir
...
G.add_edge ('J', 'M', weight=1)
G.add_edge ('H', 'M', weight=1)
